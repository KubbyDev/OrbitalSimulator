...
public class Shader {
    ...
    public static final String VERTEX_PATH = "shaders/testVertex.glsl";
    public static final String FRAGMENT_PATH = "shaders/testFragment.glsl";
    private int vertexID, fragmentID, programID;

    public Shader() {

        String vertexCode = FileUtils.readAll(VERTEX_PATH);
        String fragmentCode = FileUtils.readAll(FRAGMENT_PATH);
